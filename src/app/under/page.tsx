...
export default function UnderDevelopmentPage() {
  ...
  useEffect(() => {
    ...
    // For every 2 months, increase by 5%
    const extraProgress = Math.floor(diffMonths / 2) * 5
    const calculatedProgress = Math.min(15 + extraProgress, 100) // max 100%
      ...
      <div className="py-38 px-4 bg-gradient-to-br from-slate-900 via-emerald-900 to-emerald-950 ">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
            <span className="text-gray-900">We Are Building</span>
            <br />
          ...
          <p className="text-xl text-white/80 mb-8 max-w-xl mx-auto leading-relaxed">
            Our innovative digital banking platform for agricultural producers is under development.
            We are building the future of agricultural financing with cutting-edge technology.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-3xl mx-auto">
            <div className="bg-white/60 backdrop-blur-sm border border-amber-200/30 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Digital Bank</h3>
              <p className="text-sm text-gray-600">Modern banking solutions tailored for agriculture</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-emerald-200/30 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-sm text-gray-600">Financial insights and automation with AI technology</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-amber-200/30 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-sm text-gray-600">Revolutionary approach to agricultural financing</p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex justify-center items-center space-x-2 mb-3">
              <span className="text-sm font-medium text-white/60">Development in Progress</span>
            </div>
